...
class Quiz extends React.Component {
  state = {
    ...
    result: [],
    questions: [
      'Which is the best name in the world?', // Baby Phoolan Devi Palak Jain Babu
      'Which day is the hottest and sweetest?', 
      'Who is your favourite?', // Seeta-Geeta Laila Chhoti Peeku Potentially Chhoti Peeku
      'Your favourite quote?' // Tumne to mujhe jaana hi kaha hai. Hotness is transient. Peeku Peeku Peeku Aaja aaja aaja. Kuchh bhi chalega mujhe.
    ],
